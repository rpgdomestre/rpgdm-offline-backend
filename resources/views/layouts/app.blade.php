            ...
            <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <x-jet-responsive-nav-link href="/dashboard/articles" :active="request()->routeIs('articles')">
                            {{ __('Articles') }}
                        </x-jet-responsive-nav-link>

                        <x-jet-responsive-nav-link href="/dashboard/quizzes" :active="request()->routeIs('quizzes')">
                            {{ __('Quizzes') }}
                        </x-jet-responsive-nav-link>

                        <x-jet-responsive-nav-link href="/dashboard/crowdfunding" :active="request()->routeIs('crowdfunding')">
                            {{ __('Crowdfunding') }}
                        </x-jet-responsive-nav-link>

                        <x-jet-responsive-nav-link href="/dashboard/casts" :active="request()->routeIs('casts')">
                            {{ __('Casts') }}
                        </x-jet-responsive-nav-link>
